...
-(void)setupWithClockPlat:(PhPlatform *)cPlat counterClockPlat:(PhPlatform *)ccPlat
{
        ...
        // еее еее еее Clock Wise Information еее еее еее
        ...
        // еее еее еее Counter-Clock Wise Information еее еее еее
   ...
   // BOOL seeThough = NO; // Is there any opertunity to 'see though' to the other side?
    ...
    // еее еее еее Ceiling Checks еее еее еее
    ...
    // еее еее еее Floor Checks еее еее еее
    ...
    // еее еее еее еее еее еее еее╩еее еее
