...
// ееееееееееееееееееееее LEMapData implementation еееееееееееееееееееееееееее
#pragma mark -
#pragma mark еееееееее LEMapData implementation еееееееее
...
- (void)saveStringAsChar:(NSString *)v withLength:(int)length
{
    ...
    if (length < 0)
    {
        NSLog(@"еее ERROR: Tried to saved a string of negitive length in LEMapData->saveStringAsChar:");
        return;
    }
